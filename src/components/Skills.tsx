...
const Skills = () => {
  return (
    <section id="skills" className="bg-gradient-to-br from-blue-950/50 via-blue-800/50 to-blue-950/50 max-w-screen overflow-hidden w-full  py-20  text-white flex flex-col md:flex-row items-center gap-12 min-h-screen">
