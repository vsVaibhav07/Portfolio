...
const Skills = () => {
  return (
    <section id="skills" className="bg-gradient-to-br from-blue-950/50 via-blue-800/50 to-blue-950/50 w-screen py-20 px-6 md:px-16 text-white flex flex-col md:flex-row items-center gap-12 min-h-screen">
