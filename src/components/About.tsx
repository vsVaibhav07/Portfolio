...
export default function About() {
  return (
    ...
    >
      <div className="py-20 container-x text-white flex flex-col md:flex-row items-center gap-12 min-h-screen">
        <motion.div
        ...
        >
          ...
          <p className="text-gray-200 text-lg md:text-xl">
            ...
            and interactive websites. I enjoy turning creative ideas into
          ...
          <p className="text-gray-200 text-lg md:text-xl">
            When I’m not coding, I love exploring tech blogs, experimenting with
            animations, and contributing to open-source projects.
          </p>
        </motion.div>
      </div>
    </section>
