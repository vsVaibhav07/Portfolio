...
export default function About() {
  return (
    <section id="about" className="bg-gradient-to-br from-blue-950/50 via-blue-800/50 to-blue-950/50 w-full  py-20 container-x text-white flex flex-col md:flex-row items-center gap-12 min-h-screen">
