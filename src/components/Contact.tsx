...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="w-full  min-h-screen  bg-gradient-to-br from-blue-950/50 via-blue-800/50 to-blue-950/50 py-20 container-x text-white flex flex-col items-center"
    >
