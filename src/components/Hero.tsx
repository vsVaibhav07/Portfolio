...
export default function Hero() {
  return (
    <section  id="home" className="inset-x-0 bg-gradient-to-br from-blue-950/50 via-blue-800/50 to-blue-950/50 w-full">
       <div
    ...
    >
      ...
      >
        <div className="sm:w-72 w-52 h-52 sm:h-72 hover:scale-110 transition-transform transform-3d duration-500 md:w-60 md:h-60 lg:w-72 lg:h-72 group relative border-2 border-white rounded-full overflow-hidden">
          <Image
            src="/myImg2.png"
            alt="Profile"
            fill
